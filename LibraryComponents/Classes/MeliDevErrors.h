 ...
 *  AppIdIsNotInitializedError: when the app id is not initialized. The client does not provide the app id.
 *  RedirectUrlIsNotInitializedError: when the redirect url is not initialized. The cliend does not provide the redirect url.
